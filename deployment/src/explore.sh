...
# Split the window into seven panes
...
tmux splitw -v -p 75 # split it into two halves
tmux selectp -t 3    # select the third (3) pane
...
# Run the explore.py script with command line args in the fifth pane
